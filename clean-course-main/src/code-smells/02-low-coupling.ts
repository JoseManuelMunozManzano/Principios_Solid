(() => {
  ...
  // hace que NO haya que modificarse mucho código de otras clases. En este caso solo hemos tenido que tocar
  // en Person (y su interface) y la clase que hace la composición, UserSettings (y su interface)
  class Person {
    ...
    // Importante: Al ser desestructuración de objetos, el orden da igual
